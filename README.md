...
A lightweight, cross-platform R script to automate the process of merging multiple PDF files, standardizing their format, and removing specific unwanted pages (e.g., generic covers or blank pages).
